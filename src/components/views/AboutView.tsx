  ...
  return (
    <div className="space-y-12 pb-24 max-w-7xl mx-auto font-sans">
      ...
      <section className="relative pt-4 sm:pt-6">
        <div className="gov-card p-6 sm:p-10 rounded-2xl border border-white/20 backdrop-blur-2xl shadow-2xl space-y-6">
          <div className="flex flex-wrap items-center justify-between gap-4 border-b border-white/10 pb-6">
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2 p-2 rounded-xl bg-white/95 border-2 border-white/30 shadow-lg">
                <img src="/emblem-transparent.png" alt="State Emblem of India" className="h-8 w-auto object-contain" />
                <span className="w-px h-6 bg-slate-300"></span>
                <img src="/logo.png" alt="ISRO ChandraDrishti Logo" className="w-8 h-8 object-contain" />
              </div>
              <div>
                <span className="text-xs font-mono font-bold text-earth-400 uppercase tracking-widest block">
            ...
            <div className="flex items-center space-x-2 px-3 py-1.5 rounded-lg bg-white/5 border border-white/15 text-xs font-mono text-regolith-200">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-8 space-y-4 text-sm text-regolith-200 leading-relaxed font-sans">
            ...
            <div className="lg:col-span-4 gov-card p-5 rounded-xl border border-white/15 space-y-3 font-mono text-xs">
              <div className="text-earth-400 font-bold uppercase tracking-wider text-[11px]">
                INSTITUTIONAL DESK
              </div>
              <div className="space-y-2 text-regolith-300">
                ...
                <div className="flex items-center space-x-2 pt-1 border-t border-white/10 text-[11px] text-white">
                  <Award className="w-3.5 h-3.5 text-earth-300" />
          ...
          <div className="flex flex-wrap items-center gap-4 pt-2 border-t border-white/10">
            <button
              ...
              className="px-6 py-3.5 rounded-xl bg-white hover:bg-regolith-100 text-black font-bold text-xs tracking-wider uppercase transition-all shadow-xl flex items-center space-x-2 cursor-pointer"
            >
            ...
            <button
              ...
              className="px-6 py-3.5 rounded-xl bg-obsidian-900 hover:bg-obsidian-850 border border-white/20 text-white font-mono text-xs font-semibold transition-all flex items-center space-x-2 cursor-pointer"
            >
      ...
      <section className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="gov-card p-6 rounded-2xl border border-white/15 space-y-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                <CheckCircle2 className="w-5 h-5 text-earth-400" />
                <h3 className="text-lg font-bold text-white font-display">OHRC (Orbiter High Resolution Camera)</h3>
              </div>
              <span className="text-xs font-mono px-2 py-0.5 rounded bg-white/10 text-white border border-white/20">0.25 m/px</span>
            </div>
            <p className="text-xs text-regolith-300 leading-relaxed">
          ...
          <div className="gov-card p-6 rounded-2xl border border-white/15 space-y-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                <CheckCircle2 className="w-5 h-5 text-earth-400" />
                <h3 className="text-lg font-bold text-white font-display">TMC-2 (Terrain Mapping Camera-2)</h3>
              </div>
              <span className="text-xs font-mono px-2 py-0.5 rounded bg-white/10 text-white border border-white/20">5.0 m/px</span>
            </div>
            <p className="text-xs text-regolith-300 leading-relaxed">
