...
export const MetricsGrid: React.FC<MetricsGridProps> = ({ metrics }) => {
  ...
  const isSubPixel = metrics.rmseTotal < 2.5;

  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
      {/* CARD 1: Geometric Residual (RMSE) */}
      <ReticleFrame
        title="Geometric Residual (RMSE)"
        badge={isSubPixel ? 'OPTIMAL LOCK' : 'HIGH DISPARITY'}
          ...
          <div className="flex items-baseline justify-between">
            <div>
              ...
              <div className="text-xs font-mono text-telemetry-green flex items-center gap-1 mt-1">
                ...
                <span>Optimal Sub-Pixel Lock (&lt; 2.50 px bound)</span>
              </div>
            </div>
      ...
      <ReticleFrame
        ...
        badgeColor={metrics.inlierRatio >= 85 ? 'teal' : 'neutral'}
      >
